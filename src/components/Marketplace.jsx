    ...
    <div className="py-12 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Digital Marketplace</h2>
              ...
              {allCrops.map(crop => (
                <div key={crop.id} className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <p className="text-gray-600">
                      <span className="font-medium">Quantity:</span> {crop.quantity}
                    </p>
                    <p className="text-gray-600">
                      <span className="font-medium">Location:</span> {crop.location}
                    </p>
                    <p className="text-gray-600">
                      <span className="font-medium">Base Price:</span> {crop.basePrice}
                    </p>
                    <p className="text-primary-600 font-semibold">
                      <span className="font-medium">Current Bid:</span> {crop.currentBid}
                    </p>
                  </div>
                  
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-red-600 font-medium">
                      Ends in: {crop.timeLeft}
                    </span>
            ...
            <div>
              <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-blue-800 text-sm">
                  <strong>Note:</strong> All tenders are verified by government authorities. 
                  Bidding is supervised and transparent. Highest bid wins the tender.
                </p>
              </div>
                  ...
                  <div key={tender.id} className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Tender No: {tender.tenderNo}</p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <p className="text-gray-600 text-sm mt-1">
                          <span className="font-medium">Delivery Location:</span> {tender.deliveryLocation}
                        </p>
                        <p className="text-gray-600 text-sm mt-1">
                      ...
                      <div>
                        <p className="text-gray-600 text-sm">
                          <span className="font-medium">Base Price:</span> {tender.basePrice}
                        </p>
                        <p className="text-primary-600 font-semibold text-lg mt-1">
                          Current Highest Bid: {tender.currentBid}
                        </p>
                      </div>
                    </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                  <div className="bg-white rounded-lg max-w-md w-full p-6">
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">
                      Place Bid for {selectedTender.cropRequired}
                    </h3>
                    <p className="text-gray-600 mb-2">Tender No: {selectedTender.tenderNo}</p>
                    <p className="text-gray-600 mb-4">Current Highest Bid: {selectedTender.currentBid}</p>
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Enter amount higher than current bid to win
                      </p>
                    </div>
                ...
                {!user && (
                  <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                    <p className="text-yellow-800 text-sm">
                      Please login to post your crops on the marketplace.
                    </p>
                  </div>
                )}
            ...
            <form onSubmit={handleTenderSubmit} className="max-w-2xl mx-auto">
              <div className="space-y-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  <p className="text-blue-800 text-sm">
                    <strong>Note:</strong> Create a tender to purchase crops directly from farmers. 
                    Set your maximum price and requirements. Farmers will compete to offer the best price.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500"
                    placeholder="Where should the crop be delivered?"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500"
                    rows="3"
                    placeholder="Specify any additional requirements (moisture content, packaging, etc.)"
                  />
                </div>
                ...
                {!user || user.userType !== 'buyer' ? (
                  <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                    <p className="text-yellow-800 text-sm">
                      Only registered buyers can create tenders. Please login as a buyer to continue.
                    </p>
                  </div>
                ) : null}
